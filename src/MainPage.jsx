...
function MainPage(props) {
	const fixedMsg = 'Adam, Please Answer My Question';
         ...
         <div className='bg-black  h-full w-full'>   
            <div className='w-96 flex flex-col  items-start  mx-auto'>
                 <div className='mt-28 space-y-8'>
                      <H1>ASK ANSU</H1>
                       <P>Do you need to know anything? Are you looking for answers? Adam offers you a space to ask anything you want. However, before each question you must write a petition. If the answer is not what you expected, at least you make catharsis and ask again.</P>
                     ...
                     <div className='mt-36 space-y-16 mb-16'>    
                         <H2>How to use Adam</H2>
                         <H2>The world's best virtual tarot</H2>
                         <P>Adam is a virtual tarot that that can answer all kinds of questions. Questions about the present, the past, and your future. He can be a bit tempermental, requiring that each question be presented with a petition of "Adam, please answer the following question" or "Adam, please answer" before each question is asked. Failure to correctly petition will not bring results.</P>
                        <H2>The history of Adam</H2>
                        <P>Adam was born in 1 BC. As he began to age, he realized he had an ability to read the fortunes of others, and quickly became a star in his small hometown. To expand his operaion, he knew he had to join the digital age. Through the use of modern technology, he is able to answer thousands of questions every day from people all over the world.</P>

                        <P>In early 2022, the demand for Adam's services became so high, he brougt on 10 additional team members from around the country to increase answer throughput. With a large team, and his mind in overdrive, he is now able to answer upwards of 13,240 questions per day (Average over the past 30 days), with pinpoint accuracy. Though the team members are new, they are just as tempermental. Requiring a correct petition each and every time.</P>
                 </div>
                <H2> Any Question? </H2>
             ...
             {popUp &&
              <div className="fixed flex justify-center items-center top-0 left-0 h-screen w-screen">
               <div className="bg-black opacity-90 flex flex-col  p-8 text-white w-2/5 h-40">
                  ...
                  <h1 className="text-xl font-semibold border-b mx-12 mt-6  decoration-white flex justify-center">Adam Answer</h1>
